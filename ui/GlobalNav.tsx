...
export function GlobalNav() {
  ...
  return (
    <div className="fixed top-[65px] z-10 flex w-full flex-col border-b border-gray-800 bg-black lg:bottom-0 lg:z-auto lg:w-72 lg:border-r lg:border-gray-800">
      ...
      >
        ...
        {isOpen ? (
          <XCircleIcon className="block w-6 text-gray-400" />
        ) : (
          <MapIcon className="block w-6 text-gray-400" />
        )}
      </button>
